...
if (isset($_SESSION['role'])){
    ...
    if (isset($_POST['get_edit_item_div'])) {
        ...
        $data = array($row_item['item_name'], $row_item['item_cat'], $row_item['item_reference'], $row_item['item_quantity'], $row_item['price_min'], $row_item['price_max'], $row_item['barre_code'], $row_item['threshold']); 
