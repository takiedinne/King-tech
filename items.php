                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text square_button"><span class='fas fa-barcode' onclick="GenerateRandomBarCode()"></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
        ...
        success: function(data) {
            ...
            table = $("#AllItemsTable").DataTable({
                ...
                "rowCallback": function(row, data) {
                    ...
                    var columnValue = data[
                        3]; // Get the value of the column for this row
            ...
            $("#AllItemsTable_filter").append(
                "<button  class=\"btn btn-danger\"  data-bs-toggle=\"modal\" data-bs-target=\"#new_item\" ><i class=\"fas fa-plus pr-2\"aria-hidden=\"true\"></i> New Item</button>"
            );
            $("#AllItemsTable_filter").append("<span>   </span>");
            $("#AllItemsTable_filter").append(
                "<button class=\"btn btn-primary\" onclick='printShooping()' > Print Shooping List</button>"
            );
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 0) {
                    ...
                    create_toast("Error",
                        "Cannot delete item because it is a part of supplying or selling operations!"
                    );
                }
